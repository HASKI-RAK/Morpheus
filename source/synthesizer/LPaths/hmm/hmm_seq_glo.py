...
def synthesize_data(learning_style, data_size):
    ...
    if learning_style == "Sensory":
        path = current_directory + r"\models\model_seq.pkl"
    else:
        path = current_directory + r"\models\model_glo.pkl"
...
if __name__ == "__main__":
    synthetic_lps_sequential = synthesize_data("Sequential", 10)
